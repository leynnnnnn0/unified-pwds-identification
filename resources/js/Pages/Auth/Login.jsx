    ...
    return (
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-blue-50 to-white">
            ...
            <div className="w-full sm:max-w-md mt-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <h2 className="text-2xl font-poppins font-bold text-center text-primary-color mb-6">
                    Welcome Back
                </h2>
                ...
                <form onSubmit={submit}>
                    <div>
                        ...
                        <TextInput
                            ...
                            name="email"
                            value={data.email}
                            className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-primary-color focus:ring focus:ring-primary-color focus:ring-opacity-20"
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            {canResetPassword && (
                                <Link
                                    ...
                                    className="text-sm text-primary-color hover:text-secondary-color transition-colors font-montserrat"
                                >
                                    Forgot password?
                                </Link>
                            )}
                    ...
                    <div className="mt-6">
                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-color hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-color transition-colors font-poppins"
                        >
