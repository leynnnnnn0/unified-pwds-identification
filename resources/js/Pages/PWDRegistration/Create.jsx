                ...
                <div className="w-full rounded-lg shadow-xl border md:p-10 p-5 lg:grid lg:grid-cols-4   gap-3 auto-rows-auto space-y-2">
                    ...
                    >
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData("suffix", e.target.value)
                            }
                        />
                    </FormField>
                        ...
                        {occupations.map((item) => (
                            ...
                            >
                                ...
                                {item.hasInput ? (
                                    <BorderBInput
                                        disabled={
                                            form.data.work_field != "others"
                                        }
                                        value={
                                            (item.value ===
                                                form.data.work_field &&
                    ...
                    >
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData("sss_no", e.target.value)
                            }
                        />
                    </FormField>
                    ...
                    >
                        <Input
                            ...
                            onChange={(e) =>
                                form.setData("psn_no", e.target.value)
                            }
                        />
                    </FormField>
